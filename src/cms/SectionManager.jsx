...
const SectionRenderer = ({ section, onUpdate, pageId }) => {
  ...
  switch (section.type) {
    ...
    case SECTION_TYPES.HERO: return ( <section className="relative min-h-screen flex flex-col items-center justify-end pb-12 md:pb-20 px-6 pt-20 overflow-hidden"><LogoBackground /><div className="relative z-10 text-center max-w-4xl mx-auto pointer-events-none mb-12 lg:mb-16"><FadeIn delay={1.2} className="pointer-events-auto"><div className="text-charcoal-light font-light text-base md:text-lg max-w-xs md:max-w-lg mx-auto leading-relaxed"><Text field="subtitle" defaultValue="" multiline /></div></FadeIn></div></section> );
    case SECTION_TYPES.DOUBLE_ENTRY: return ( <section className="px-6 relative z-10 -mt-20 pb-20"><FadeIn delay={1.4} className="relative z-20 w-full max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 pointer-events-auto"><EditableLink to="/pratique-manuelle" className="group relative block p-8 border border-white/5 bg-paper/20 backdrop-blur-sm hover:bg-sage/40 transition-all duration-700 text-center rounded-sm overflow-hidden"><div className="absolute inset-0 border border-transparent group-hover:border-clay/20 transition-colors duration-700"></div><div className="relative z-10"><span className="inline-block p-4 rounded-full bg-white/5 text-clay mb-6 group-hover:scale-110 transition-transform duration-500"><SafeIcon icon={PiHandPalmLight} className="text-2xl" /></span><h2 className="text-xl md:text-2xl font-serif text-charcoal mb-4 italic group-hover:text-clay transition-colors duration-500"><Text field="card1Title" defaultValue="Soin & Thérapie" /></h2><div className="text-charcoal-light/80 font-light text-sm mb-8 leading-relaxed"><Text field="card1Desc" defaultValue="Séances..." multiline /></div><span className="inline-block text-[10px] uppercase tracking-[0.25em] text-clay border-b border-clay/30 pb-1 group-hover:border-clay transition-all duration-500"><Text field="card1Cta" defaultValue="Découvrir la pratique" /></span></div></EditableLink><EditableLink to="/formations" className="group relative block p-8 border border-white/5 bg-paper/20 backdrop-blur-sm hover:bg-sage/40 transition-all duration-700 text-center rounded-sm overflow-hidden"><div className="absolute inset-0 border border-transparent group-hover:border-clay/20 transition-colors duration-700"></div><div className="relative z-10"><span className="inline-block p-4 rounded-full bg-white/5 text-clay mb-6 group-hover:scale-110 transition-transform duration-500"><SafeIcon icon={FiIcons.FiBookOpen} className="text-2xl" /></span><h2 className="text-xl md:text-2xl font-serif text-charcoal mb-4 italic group-hover:text-clay transition-colors duration-500"><Text field="card2Title" defaultValue="Formation & Transmission" /></h2><div className="text-charcoal-light/80 font-light text-sm mb-8 leading-relaxed"><Text field="card2Desc" defaultValue="Cursus..." multiline /></div><span className="inline-block text-[10px] uppercase tracking-[0.25em] text-clay border-b border-clay/30 pb-1 group-hover:border-clay transition-all duration-500"><Text field="card2Cta" defaultValue="Voir les enseignements" /></span></div></EditableLink><EditableLink to="/ateliers" className="group relative block p-8 border border-white/5 bg-paper/20 backdrop-blur-sm hover:bg-sage/40 transition-all duration-700 text-center rounded-sm overflow-hidden"><div className="absolute inset-0 border border-transparent group-hover:border-clay/20 transition-colors duration-700"></div><div className="relative z-10"><span className="inline-block p-4 rounded-full bg-white/5 text-clay mb-6 group-hover:scale-110 transition-transform duration-500"><SafeIcon icon={FiIcons.FiCalendar} className="text-2xl" /></span><h2 className="text-xl md:text-2xl font-serif text-charcoal mb-4 italic group-hover:text-clay transition-colors duration-500"><Text field="card3Title" defaultValue="Ateliers" /></h2><div className="text-charcoal-light/80 font-light text-sm mb-8 leading-relaxed"><Text field="card3Desc" defaultValue="Pratiques..." multiline /></div><span className="inline-block text-[10px] uppercase tracking-[0.25em] text-clay border-b border-clay/30 pb-1 group-hover:border-clay transition-all duration-500"><Text field="card3Cta" defaultValue="Voir les ateliers" /></span></div></EditableLink></FadeIn></section> );
